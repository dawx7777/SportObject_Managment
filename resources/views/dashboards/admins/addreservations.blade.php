...
markers.push({
    ...
    content: `<div><a href='admin/reservations/${datas[index].id}'><h5 style="color:red; ">Nazwa: ${datas[index].name}</h5></a> <p>Adres:<i></i>${datas[index].adress}</p><p>${datas[index].city},${datas[index].state}</p><p>Godziny: <small>${datas[index].hours}</small></p><img src='images/objects/${datas[index].picture}'></div>`
})
}
