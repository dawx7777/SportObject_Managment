...
<img src="{{Auth::user()-> picture}}" alt="Avatar" class="avatar">
            ...
            <div class="" >
                <div class="ibox">
                    <div class="ibox-content">
                        <div class="row-6">
                            <div class="col">
                              <h5>Kliknij aby dołączyć do zepołu</h5>
                            <form method="POST" action="{{route('jointeam',$tem->id)}}">
            @csrf
    ...
    <h5>Jako założyciel dodaj zwykłych graczy</h5>
          ...
          @endif
                        ...
                        <div id="dialog_book">
    <div id="dialog_body">
        <form id="dayClick" method="POST" action="{{route('jointeamplayer',$tem->id)}}">
        @csrf
                                ...
                                @foreach($teamusers as $teamuser)
                                    <div class="feed-element">
                                        ...
                                        <div class="media-body ">
                                            ...
                                            @if(Auth::user()->email == $tem->email)
                                              <form method="POST" action="{{route('teamuserdestroy',$teamuser->id)}}">
               @csrf
               @method('DELETE')
             <button type="submit" class="btn" style="width:50px; background-color:red;">
