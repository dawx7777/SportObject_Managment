    ...
    <div class="container">
			<div class="row">
				<div class="col-lg-12">
                    ...
                    @foreach($objsearch as $obj)
						<div class="object-grid">
							<div class="object-grid-image"><img src="{{asset('/images/objects/'. $obj->picture)}}" alt="">
								...
								<div class="object-grid-txt">
									...
									<h2>{{$obj->name}}</h2>
									<ul>
										<li><i class="fa fa-square" aria-hidden="true"></i> {{$obj->width}}m x {{$obj->lenght}}m  <small>{{$obj->count}}</small></li>
										<li><i class="fa fa-futbol-o" aria-hidden="true"></i> {{$obj->type}}</li><br>
                                        <li><i class="fa fa-lightbulb-o" aria-hidden="true"></i> {{$obj->light}}</li>
										<li><i class=" fa fa-map-marker" aria-hidden="true"></i> {{$obj->adress}} , {{$obj->city}}</li>
									</ul>
									
									<a href="user/object/{{$obj['id']}}">Przejdź...</a>
								</div>
							</div>
                            @endforeach
