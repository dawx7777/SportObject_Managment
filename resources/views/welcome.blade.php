...
<body>
    ...
    <header>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="navbar-nav ml-auto">
              ...
              <a class="nav-item nav-link" href="{{ url('about') }}">O PRACY</a>
    ...
    <section id="row">
        <div id="col-2">
            <h1 class="text-smooth" data-text="Aplikcja_Orlikowa!">Aplikcja_Orlikowa!</h1>
            <p class="text-smooth" data-text="Jeśli chcesz skorzytać z usług 
            zaloguj się lub zarejestruj swoje konto">
                Jeśli chcesz skorzytać z usług 
                zaloguj się lub zarejestruj swoje konto
            </p>
            @if (Route::has('login'))
            @auth
            ...
            <a href="{{ route('register') }}" class="btn">Zarejestruj &#8594; </a>
            @endif
                @endauth
        </div>
        @endif
